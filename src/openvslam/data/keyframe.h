...
public:
    ...
    //修改  
    std::vector<ucoslam::MarkerObservation> get_markers() const;
    ...
    void add_MarkerObservation(ucoslam::MarkerObservation& mk);
    void erase_MarkerObservation(ucoslam::MarkerObservation& mk);
...
//修改：
    const std::vector<aruco::Marker> markerpts_;
    const std::vector<aruco::Marker> markerpts_right_;
    //ucoslam::makers
...
//修改
    mutable std::mutex mtx_markers_;
    //-----------------------------------------
    // databases
